...
/* ns:readResponse */
struct ns__readResponse
{
public:
	std::vector<unsigned char >*response;	/* SOAP 1.2 RPC return element (when namespace qualified) */	/* optional element of type xsd:unsignedByte */
public:
	int soap_type() const { return 12; } /* = unique type id SOAP_TYPE_ns__readResponse */
};
#endif
...
public:
	int soap_type() const { return 13; } /* = unique type id SOAP_TYPE_ns__read */
};
#endif
